plot4<-function(){
    ...
    par(mfrow = c(2,2))
    #Plot 1 
    plot(data_file$Time2, data_file$Global_active_power, type = "l", 
         xlab = "", ylab = "Global Active Power")
    #Plot 2
    plot(data_file$Time2, data_file$Voltage, type = "l", 
    ...
    #plot 4
    plot(data_file$Time2, data_file$Global_reactive_power, xlab = "datetime", 
